package instance.morpheus.plugins
...
class InstanceTabAInstanceTabProvider extends AbstractInstanceTabProvider {
	protected MorpheusContext morpheusContext
	protected Plugin plugin

	InstanceTabAInstanceTabProvider(Plugin plugin, MorpheusContext morpheusContext) {
	...
	@Override
	String getCode() {
		return "instance-tab-a-instanceTab"
	}
